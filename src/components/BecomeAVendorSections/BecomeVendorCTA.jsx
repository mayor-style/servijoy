...
const BecomeVendorCTA = () => {
  ...
  return (
    <section className="w-full py-16 bg-gradient-to-r from-gray-900 to-gray-800 text-center text-white relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-20">
        {/* Heading */}
        <h2 className="xs:text-3xl text-2xl md:text-4xl font-bold text-gradient">
          Elevate Your Business, Unlock More Opportunities
        </h2>
        <p className="md:text-lg max-xs:text-sm text-gray-300 mt-4 max-w-3xl mx-auto">
