const ReviewSection = () => {
    return (
      <div className="my-8 overflow-hidden p-6">
        <h2 className="sm:text-2xl text-lg xs:text-xl  font-semibold mb-4">Customer Reviews</h2>
  
        {/* Review Item */}
        <div className="revie bg-white p-4 rounded-xl shadow-md mb-4">
        ...
        {/* Another Review */}
        <div className="reviw bg-white max-sm:text-sm p-4 rounded-xl shadow-md">
