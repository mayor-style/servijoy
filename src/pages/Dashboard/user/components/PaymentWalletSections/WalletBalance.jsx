...
const WalletBalance = ({ balance, onTopUp, onWithdraw }) => {
  return (
    <div className="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between transition-colors duration-300 gap-4 sm:gap-6">
      <div>
        <h2 className="text-xl sm:text-2xl font-bold dark:text-white">Wallet Balance</h2>
      ...
      <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
        ...
        <button
          onClick={onWithdraw}
          className="px-4 sm:px-6 py-2 sm:py-3 bg-green hover:bg-green text-white rounded-md transition-colors duration-200"
        >
          Withdraw
        </button>
      </div>
