...
const Favorites = () => {
  ...
  return (
    <div className="min-h-screen  dark:bg-gray-900 py-6 px-0">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl md:text-4xl font-bold text-left dark:text-white max-sm:text-center font-header mb-6 md:mb-8">
          My Favorites
        </h1>
        {favorites.length === 0 ? (
